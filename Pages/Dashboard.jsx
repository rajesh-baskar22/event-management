...
const Home = ({ userData }) => {
  ...
  return (
    <>
      {/* <Register/> */}
      <div className="relative pt-[70px] h-screen bg-blue-50">
        <header className='flex shadow-md py-1 px-4 sm:px-7 bg-blue-600 min-h-[70px] tracking-wide z-[110] fixed top-0 w-full'>
          <div className='flex flex-wrap items-center justify-between gap-4 w-full relative'>
            <button
              onClick={() => navigate(-1)}
              className="bg-white text-blue-600 px-4 py-2 rounded-lg shadow hover:bg-blue-100 absolute top-2 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
            >
              Go Back
            </button>
            <a href="javascript:void(0)"><img src="https://outranking.s3.amazonaws.com/934231_Monique%20Dahito/60468988/2023-11-17T01%3A00%3A46.305102_6f3f414e-5d15-4d56-a006-05ccb7cd997a" alt="logo" className='absolute left-28 bottom-1 h-[68px] w-40 brightness-0 invert' />
            </a>

            <div id="collapseMenu"
              className='max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50'>
              <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white p-3'>
                <svg xmlns="http://www.w3.org/2000/svg" className="w-3 fill-white" viewBox="0 0 320.591 320.591">
                  <path
              ...
              <div
                className="max-lg:fixed max-lg:bg-blue-50 max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                <div className='flex items-center max-lg:flex-col-reverse max-lg:ml-auto gap-8'>
                  <div className="flex w-full bg-blue-100 px-6 py-1 rounded outline-none focus-within:border-blue-600 focus-within:bg-blue-50 transition-all">
                    <input
                      type="text"
                    ...
                    <svg
                      ...
                      width="16px"
                      className="cursor-pointer right-0 fill-blue-400"
                    >
                  ...
                  <div className='flex items-center space-x-6 max-lg:flex-wrap'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 cursor-pointer fill-blue-600 hover:fill-blue-800"
                    ...
                    <div
                      ...
                      <div className="w-full">
                        <a href="javascript:void(0)"
                          className="text-sm text-gray-800 cursor-pointer flex items-center p-2 rounded-md hover:bg-pink-50 dropdown-item transition duration-300 ease-in-out">
                          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-3 fill-pink-500"
                            viewBox="0 0 512 512">
                            <path
                          ...
                          Account</a>
                        <hr className="my-2 -mx-2 border-pink-100" />

                        <a href="javascript:void(0)"
                          className="text-sm text-gray-800 cursor-pointer flex items-center p-2 rounded-md hover:bg-pink-50 dropdown-item transition duration-300 ease-in-out">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4 h-4 mr-3 fill-pink-500" viewBox="0 0 24 24">
                        ...
                        <a href="javascript:void(0)"
                          className="text-sm text-gray-800 cursor-pointer flex items-center p-2 rounded-md hover:bg-pink-50 dropdown-item transition duration-300 ease-in-out">
                          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-3 fill-pink-500" viewBox="0 0 24 24">
                            <path
                              d="M18 2c2.206 0 4 1.794 4 4v12c0 2.206-1.794 4-4 4H6c-2.206 0-4-1.794-4-4V6c0-2.206 1.794-4 4-4zm0-2H6a6 6 0 0 0-6 6v12a6 6 0 0 0 6 6h12a6 6 0 0 0 6-6V6a6 6 0 0 0-6-6z"
                              data-original="#000000" />
                            <path d="M12 18a1 1 0 0 1-1-1V7a1 1 0 0 1 2 0v10a1 1 0 0 1-1 1z" data-original="#000000" />
                        ...
                        <Link to={"/login"}>
                          <a href="javascript:void(0)"
                            className="text-sm text-gray-800 cursor-pointer flex items-center p-2 rounded-md hover:bg-pink-50 dropdown-item transition duration-300 ease-in-out">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-3 fill-pink-500" viewBox="0 0 6 6">
                              <path
            ...
            <section className="main-content w-full overflow-auto p-6">
              <div className="overflow-x-auto">
                <div id='profileContent' className={`max-w-md w-full bg-white absolute top-16 right-80 rounded-lg p-6  ${activeTab === 'profile' ? 'block' : 'hidden'}`} >
                  <div className='flex justify-center'>
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxn6HttfyveJwe2VY0xQYuwC7_3JdVOnLnKg&s" alt="profile-pic"
                      className="w-40 h-40 max-lg:w-16 max-lg:h-16 rounded-full border-2 border-gray-300 cursor-pointer" />
                  </div>
                ...
                <div id='postContent' className={`container mx-auto mt-8 ${activeTab === 'post' ? 'block' : 'hidden'}`}>
                  ...
                  <div
                    className="fixed inset-0 p-4 flex flex-wrap justify-center items-center  w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]" id='form'>
                    <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                      <div className="flex items-center pb-3 border-b border-gray-300">
                        <h3 className="text-gray-800 text-xl font-bold flex-1">The terms and conditions of event creater</h3>
                      ...
                      <div className="my-6">
                        <p className="text-gray-600 text-sm leading-relaxed"> Event organizers often have terms and conditions that govern the relationship between the organizer and attendees, vendors, or sponsors. These terms and conditions typically outline the rights and responsibilities of all parties involved in the event.
                          Some common terms and conditions that event organizers may include are:</p>
                        <p className="text-gray-600 text-sm leading-relaxed mt-2"><b>Ticket sales:</b> This section may cover topics such as ticket prices, refunds, and exchanges.</p>
                        <p className="text-gray-600 text-sm leading-relaxed mt-2"><b>Event policies:</b> This section may cover topics such as prohibited items, security procedures, and emergency protocols.</p>
                        <p className="text-gray-600 text-sm leading-relaxed mt-2"><b>Intellectual property:</b> This section may cover topics such as copyright, trademarks, and patents.</p>
                        <p className="text-gray-600 text-sm leading-relaxed mt-2"><b>Liability:</b> This section may cover topics such as the organizer's liability for injuries or damages that occur at the event</p>
                        <p className="text-gray-600 text-sm leading-relaxed mt-2"><b>Important:</b> You are creating Event the admin cen accept to approve your event can post public.So, you can inform or wait and move forther step.
                        </p>
                      </div>

                      <div className="border-t border-gray-300 pt-6 flex justify-end gap-4">
                        <button type="button" id='myBtn'
                          className="px-4 py-2  rounded-lg text-white text-sm border-none outline-none tracking-wide bg-blue-600 hover:bg-blue-700 active:bg-blue-600">Accept</button>
                      </div>
                    </div>
                  </div>
