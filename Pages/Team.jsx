...
const Team = () => {
    return (
        <>
         <div className="font-[sans-serif] max-w-5xl max-lg:max-w-4xl  max-sm:max-w-sm mx-auto mt-4">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-6 gap-y-16 text-center mt-24">
                <div className="bg-gray-200 relative rounded">
                    ...
                    <div className="py-4">
                        <h4 className="text-gray-800 text-base font-extrabold">Rajesh</h4>
                ...
                <div className="bg-gray-200 relative rounded">
                    ...
                    <div className="py-4">
                        <h4 className="text-gray-800 text-base font-extrabold">Raju</h4>
                        <p className="text-gray-800 text-xs mt-1">Software Engineer</p>
                ...
                <div className="bg-gray-200 relative rounded">
                    ...
                    <div className="py-4">
                        <h4 className="text-gray-800 text-base font-extrabold">Sindhu</h4>
                ...
                <div className="bg-gray-200 relative rounded">
                    ...
                    <div className="py-4">
                        <h4 className="text-gray-800 text-base font-extrabold">Charu</h4>
                        <p className="text-gray-800 text-xs mt-1">Web Designer</p>
